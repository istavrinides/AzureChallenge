    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                // User has already logged in once and has been created in the backend. Redirect to resend email
                if (result.IsNotAllowed)
                {
                    return RedirectToPage("./EmailNotConfirmed", new { Email = Input.Email });
                }
                else
                {
                    return Page();

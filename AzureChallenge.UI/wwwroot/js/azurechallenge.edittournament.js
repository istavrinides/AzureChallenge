                        ...
                        if (globalParams) {
                            ...
                            for (var i = 0; i < data.textParameters.length; i++) {
                                ...
                                if (globalParams.parameters[data.textParameters[i].replace('Global.', '')]) {
                                    container.append("<div class='form-group col-6'> \
                                                          <input class='form-control' name='QuestionToAdd.TextParameters[" + i + "].Value' id='QuestionToAdd_TextParameters_" + i + "__Value' value='" + globalParams.parameters[data.textParameters[i].replace('Global.', '')] + "' readonly /> \
                                                    </div>");
                                }
                                else {
                            ...
                            for (i = 0; i < data.uris.length; i++) {
                                ...
                                for (var j = 0; j < data.uris[i].uriParameters.length; j++) {
                                    ...
                                    if (globalParams.parameters[data.uris[i].uriParameters[j].replace('Global.', '')]) {
                                        toAppend += "<div class='form-group col-6'> \
                                                        <input class='form-control' name='QuestionToAdd.Uris[" + i + "].UriParameters[" + j + "].Value' id='QuestionToAdd_Uris_" + i + "__UriParameters_" + j + "__Value' value='" + globalParams.parameters[data.uris[i].uriParameters[j].replace('Global.', '')] + "' readonly /> \
                                                     </div>";
                                    }
                                    else {
    ...
    $.get("/Administration/Tournament/" + tournamentId + "/AssignedQuestion/" + selectedQuestionId)
        .done(function (data) {
            ...
            for (var i = 0; i < data.textParameters.length; i++) {
                ...
                // Check if this is a global parameters
                if (data.textParameters[i].key.startsWith('Global.')) {
                    container.append("<div class='form-group col-6'> \
                                                    <input class='form-control' name='QuestionToAdd.TextParameters[" + i + "].Value' id='QuestionToAdd_TextParameters_" + i + "__Value' value='" + data.textParameters[i].value + "' readonly /> \
                                            </div>");
                }
                else {
                    container.append("<div class='form-group col-6'> \
            ...
            for (i = 0; i < data.uris.length; i++) {
                ...
                for (var j = 0; j < data.uris[i].uriParameters.length; j++) {
                    ...
                    // Check if this is a global parameters
                    if (data.uris[i].uriParameters[j].key.startsWith('Global.')) {
                        toAppend += "<div class='form-group col-6'> \
                                                        <input class='form-control' name='QuestionToAdd.Uris[" + i + "].UriParameters[" + j + "].Value' id='QuestionToAdd_Uris_" + i + "__UriParameters_" + j + "__Value' value='" + data.uris[i].uriParameters[j].value + "' readonly /> \
                                                     </div>";
                    }
                    else {
